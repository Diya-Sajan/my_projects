...
def resetAll(root,frame1):
    ...
    msg = Message(frame1, bg='#5B85AA',text="Reset Complete", width=500)
...
def showVotes(root,frame1):
    ...
    Label(frame1, bg="#5B85AA",text="BJP              :       ", font=('Helvetica', 12, 'bold')).grid(row = 2, column = 1)
    Label(frame1, bg="#5B85AA",text=result['bjp'], font=('Helvetica', 12, 'bold')).grid(row = 2, column = 2)

    Label(frame1, bg="#5B85AA",text=" Cong             :          ", font=('Helvetica', 12, 'bold')).grid(row = 3, column = 1)
    Label(frame1, bg="#5B85AA",text=result['cong'], font=('Helvetica', 12, 'bold')).grid(row = 3, column = 2)

    Label(frame1, bg="#5B85AA",text=" AAP               :          ", font=('Helvetica', 12, 'bold')).grid(row = 4, column = 1)
    Label(frame1, bg="#5B85AA",text=result['aap'], font=('Helvetica', 12, 'bold')).grid(row = 4, column = 2)

    Label(frame1, bg="#5B85AA",text=" Shiv Sena    :          ", font=('Helvetica', 12, 'bold')).grid(row = 5, column = 1)
    Label(frame1, bg="#5B85AA",text=result['ss'], font=('Helvetica', 12, 'bold')).grid(row = 5, column = 2)

    Label(frame1, bg="#5B85AA",text=" NOTA            :          ", font=('Helvetica', 12, 'bold')).grid(row = 6, column = 1)
    Label(frame1, bg="#5B85AA",text=result['nota'], font=('Helvetica', 12, 'bold')).grid(row = 6, column = 2)
